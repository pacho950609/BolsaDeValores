...
public class ServletRegistrarOrden extends  HttpServlet{
	    ...
	    protected void doPost( HttpServletRequest request, HttpServletResponse response ) throws ServletException, IOException
	    {
                  ...
                  //REGISTRA UN PRIMARIO
                       
//                         String idreg = request.getParameter( "id" );
//                         String sentancia1="SELECT * FROM OPERACIONES_EN_ESPERA_PRIM WHERE ID='"+id+"'";
//                         PrintWriter respuesta = response.getWriter() ;
//                         conexionDB x = new conexionDB();
//                         ResultSet r1 = x.consultar(sentancia1);
//                         
//                         
//                         
//                          String sentanciaINSERT="INSERT INTO DISPONINLE_VENDER VALUES("
//                                    +nuevoid 
//                                    +",'"+emailInversionista 
//                                    +"','"+nombreValor
//                                    + "'," +nit
...
//                         if(rta)
//                         {
//                             String mensaje="Se ha registrado exitosamente la orden";
//                             imprimirhtmlprimario(respuesta, mensaje);
//                         }
//                         else{
//                              String mensaje="no se ha podido borrar la orden";
